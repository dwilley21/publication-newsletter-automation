    ...
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
      <div class="flex items-center">
        ...
        <div>
          ...
          <p class="text-xs text-gray-500">v1.2.0 - Brevo Campaign Manager</p>
        </div>
      </div>
      <div class="flex items-center space-x-4">
        <a 
          href="https://github.com/dwilley21/publication-newsletter-automation" 
          target="_blank"
        ...
        <a 
          href="https://www.brevo.com/docs/api/" 
          target="_blank"
          rel="noopener noreferrer"
          class="text-gray-600 hover:text-gray-800 flex items-center"
          title="Brevo API Docs"
        >
